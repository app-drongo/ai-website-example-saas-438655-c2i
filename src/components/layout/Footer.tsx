...
export default function Footer({
  ...
  companyDescription = 'Streamline your workflow with our powerful SaaS platform. Trusted by over 10,000 businesses worldwide to automate processes, boost productivity, and drive growth through intelligent automation.',
  ...
  newsletterDisclaimer = 'Get feature updates, tips, and exclusive offers. Unsubscribe anytime with one click.',
