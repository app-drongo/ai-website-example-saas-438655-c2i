...
const DEFAULT_HERO = {
  badge: 'New: Enterprise AI Integration',
  title: 'Scale your business with',
  titleHighlight: 'intelligent automation',
  description:
    'Transform your workflow with our AI-powered SaaS platform. Reduce manual tasks by 80% and accelerate growth with intelligent automation built for modern teams.',
  features: [
  ...
  statsValue1: '80% faster',
  statsLabel2: 'Customer Satisfaction',
  statsValue2: '4.9/5 rating',
} as const;
