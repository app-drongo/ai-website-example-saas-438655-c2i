...
export default function Cta({
  badge = '🚀 Scale Your Business Today',
  mainTitle = 'Ready to Accelerate Your',
  mainTitleHighlight = 'SaaS Growth?',
  description = 'Join 50,000+ businesses already using our platform to streamline operations, boost productivity, and scale faster. Start your 14-day free trial today.',
  primaryCTA = 'Start Free Trial',
  primaryCTAHref = '/signup',
  secondaryCTA = 'Book a Demo',
  secondaryCTAHref = '/contact',
  trustText = 'Trusted by leading tech companies worldwide',
  stat1Value = '50K+',
  ...
  feature3Description = 'Get up and running with our guided onboarding',
}: CTAProps) {
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                <Button
                  size="lg"
                  className="group text-base px-8 py-4 bg-primary hover:bg-primary/90 text-primary-foreground"
